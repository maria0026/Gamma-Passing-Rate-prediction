...
def shift_image(ref_dist, eval_dist):
    ref_dist, ref_slope, ref_intercept, ref_size =normalize_image(ref_dist, reference=True, evaluation=False)
    eval_dist, eval_slope, eval_intercept, meterset_exposure, eval_size =normalize_image(eval_dist, reference=False, evaluation=True)
